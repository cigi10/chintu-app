...
export const RAW_PACKS = {
  ...
  Foundation: {
    Math: [
      "Number Systems", "Fractions & Decimals", "Ratio & Proportion", "Basic Algebra",
      "Linear Equations", "Basic Geometry", "Mensuration", "Data Handling",
    ],
    Science: [
      "Matter & Its States", "Basic Chemistry", "Motion & Forces", "Basic Biology",
      "The Human Body", "Plants & Life Processes", "Light & Sound", "Our Environment",
    ],
  },
};
