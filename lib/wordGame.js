 ...
 * on-screen keyboard: a letter keeps the best status it's ever earned
 * across guesses (a letter marked "present" in one guess and "correct"
 * in a later one should show correct, never regress).
 */
export function computeKeyStatuses(guesses, target) {
  const statuses = {};
